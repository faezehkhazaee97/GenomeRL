"""Evaluate a fine-tuned DNABERT-2 + RL grouping checkpoint."""
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", type=str, default="results/rl_runs/grpo_finetuned_env/agent_env_last.pt")
    ...
    print("=" * 80)
    print("Fine-tuned-env GenomeRL evaluation metrics")
    print(json.dumps(metrics, indent=2))

    output_dir = Path(config.get("training", {}).get("output_dir", "results/rl_runs/grpo_finetuned_env"))
